...
pref("__prefsPrefix__.selectedApiProfileId", "default-openai");
pref(
...
pref(
  ...
  "你是一名严谨的专业翻译助手。请将下面内容翻译为 ${targetLanguage}，保持术语准确和原意完整。输入是单词时给出简明且准确的释义；输入是句子或段落时仅输出完整译文，并按原文段落分行。不要添加与翻译无关的说明。\n\n待翻译内容：\n${sourceText}",
);
